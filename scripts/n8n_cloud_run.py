...
from automation.envfile import ConfigError, N8nCloudRunConfig, load_dotenv_defaults
from automation.n8n_cloud_run_service import CommandExecutionError, N8nCloudRunResult, N8nCloudRunService


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Deploy or inspect the n8n Cloud Run service.")
...
def emit_result(result: N8nCloudRunResult, *, output_format: str) -> None:
...
def main() -> int:
    ...
    try:
        ...
        config = N8nCloudRunConfig.from_environment()
    ...
    try:
        service = N8nCloudRunService(config)
